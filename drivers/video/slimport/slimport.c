...
static ssize_t hdcp_ctrl_show(struct device *dev, struct device_attribute *attr,
		 char *buf)
{
...
static ssize_t hdcp_ctrl_store(struct device *dev, struct device_attribute *attr,
		 const char *buf, size_t count)
{
	int ret;
	long val;
